...
LOCALE_PATHS = [
    os.path.join(BASE_DIR, 'xblock_jupyter_graded/translations'),
]

# statici18n
# http://django-statici18n.readthedocs.io/en/latest/settings.html

with open(os.path.join(BASE_DIR, 'xblock_jupyter_graded/translations/config.yaml'), 'r') as locale_config_file:
...
STATICI18N_NAMESPACE = 'JUPYTERGRADEDXBLOCKI18N'
STATICI18N_PACKAGES = (
    'xblock_jupyter_graded',
)
STATICI18N_ROOT = 'xblock_jupyter_graded/public/js'
